...
import Review from "../review/WritingReview";
...
const handleAddCart = () => {
  ...
  const handleAddWishlist = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (productId) dispatch(addProductToWishlist({ productId: Number(productId) }));
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <section>
          ...
          <div className="mt-12 flex items-center gap-5">
            ...
            <Button variant="outlined" onClick={handleAddWishlist} fullWidth startIcon={<FavoriteBorder />}>
              Wishlist
            </Button>
          </div>
          <div className="mt-5">
