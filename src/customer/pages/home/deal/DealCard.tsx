...
const DealCard = ({deal}:{deal:Deal}) => {
  ...
  return (
    ...
    <img className='border-x-[7px] border-t-[7px] border-primary-color w-full h-[12rem] object-cover object-top' src={deal.homeCategory?.image} alt="" />
    <div className='border-4 border-black bg-black text-white p-1 text-center'>
        <p className='text-lg font-semibold'>{deal.homeCategory?.categoryId.split("_").join(" ")}</p>
