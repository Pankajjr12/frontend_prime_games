  ...
  return (
    <div
      style={{
        ...
        position: 'relative',
        width: '100%',
        height: 'auto', // Allow height to be dynamic based on the image aspect ratio
      }}
      onClick={toggleZoom}
    ...
    >
      <img
        ...
        alt={alt}
        style={{
          width: isZoomed ? '200%' : '100%', // Zooming the width
          height: isZoomed ? 'auto' : 'auto', // Maintain aspect ratio for height
